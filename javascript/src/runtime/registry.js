...
export const examples = [abstractFactoryExample, adapterExample, decoratorExample, factoryMethodExample, simpleFactoryExample, singletonExample, strategyExample];
