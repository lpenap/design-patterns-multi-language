# Tasks: One Class per File — Close-out

- [x] T001 `ONE_CLASS_PER_FILE_LEVEL` to `"error"`; validate and CLI tests updated with `conformStructure`
- [x] T002 Participants tables: link every participant to its file in all four languages; zero broken links
