 ...
 */
export const examples: readonly Example[] = [abstractFactoryExample, adapterExample, chainOfResponsibilityExample, decoratorExample, factoryMethodExample, observerExample, producerConsumerExample, simpleFactoryExample, singletonExample, strategyExample, templateMethodExample];
