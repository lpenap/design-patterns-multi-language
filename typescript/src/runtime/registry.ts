 ...
 */
export const examples: readonly Example[] = [abstractFactoryExample, adapterExample, factoryMethodExample, simpleFactoryExample, singletonExample, strategyExample];
