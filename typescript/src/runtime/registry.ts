 ...
 */
export const examples: readonly Example[] = [abstractFactoryExample, adapterExample, chainOfResponsibilityExample, decoratorExample, factoryMethodExample, simpleFactoryExample, singletonExample, strategyExample];
