 ...
 */
export const examples: readonly Example[] = [abstractFactoryExample, adapterExample, decoratorExample, factoryMethodExample, simpleFactoryExample, singletonExample, strategyExample];
