 ...
 */
export const examples: readonly Example[] = [abstractFactoryExample, adapterExample, chainOfResponsibilityExample, decoratorExample, factoryMethodExample, observerExample, simpleFactoryExample, singletonExample, strategyExample];
