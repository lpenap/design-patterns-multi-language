...
| Client | Traverses through the Iterator interface only. | [`IteratorExample`](../../java/src/main/java/com/penapereira/patterns/iterator/IteratorExample.java) | `IteratorExample` | [`iteratorExample`](../../typescript/src/iterator/example.ts) | [`iteratorExample`](../../javascript/src/iterator/example.js) |
