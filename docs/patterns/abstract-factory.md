...
|---|---|---|---|---|---|
| AbstractFactory | Declares one creation operation per abstract product: `createProductA()`, `createProductB()`. | [`AbstractFactory`](../../java/src/main/java/com/penapereira/patterns/abstractfactory/AbstractFactory.java) | [`AbstractFactory`](../../python/src/patterns/abstractfactory/abstract_factory.py) (Protocol; `create_product_a`, `create_product_b`) | [`AbstractFactory`](../../typescript/src/abstract-factory/abstract-factory.ts) | implicit: any object with both `create` methods ([`abstract-factory/`](../../javascript/src/abstract-factory/)) |
| ConcreteFactory | Implements the operations for one family. | [`ConcreteFactory1`](../../java/src/main/java/com/penapereira/patterns/abstractfactory/ConcreteFactory1.java), [`ConcreteFactory2`](../../java/src/main/java/com/penapereira/patterns/abstractfactory/ConcreteFactory2.java) | [`ConcreteFactory1`](../../python/src/patterns/abstractfactory/concrete_factory1.py), [`ConcreteFactory2`](../../python/src/patterns/abstractfactory/concrete_factory2.py) | [`ConcreteFactory1`](../../typescript/src/abstract-factory/concrete-factory1.ts), [`ConcreteFactory2`](../../typescript/src/abstract-factory/concrete-factory2.ts) | [`ConcreteFactory1`](../../javascript/src/abstract-factory/concrete-factory1.js), [`ConcreteFactory2`](../../javascript/src/abstract-factory/concrete-factory2.js) |
| AbstractProduct | Declares the interface of each kind of product; both expose only `name()`. | [`AbstractProductA`](../../java/src/main/java/com/penapereira/patterns/abstractfactory/AbstractProductA.java), [`AbstractProductB`](../../java/src/main/java/com/penapereira/patterns/abstractfactory/AbstractProductB.java) | [`AbstractProductA`](../../python/src/patterns/abstractfactory/abstract_product_a.py), [`AbstractProductB`](../../python/src/patterns/abstractfactory/abstract_product_b.py) (Protocols) | [`AbstractProductA`](../../typescript/src/abstract-factory/abstract-product-a.ts), [`AbstractProductB`](../../typescript/src/abstract-factory/abstract-product-b.ts) | implicit: any object with `name()` |
| ConcreteProduct | The products themselves; the digit denotes the family. | [`ProductA1`](../../java/src/main/java/com/penapereira/patterns/abstractfactory/ProductA1.java), [`ProductA2`](../../java/src/main/java/com/penapereira/patterns/abstractfactory/ProductA2.java), [`ProductB1`](../../java/src/main/java/com/penapereira/patterns/abstractfactory/ProductB1.java), [`ProductB2`](../../java/src/main/java/com/penapereira/patterns/abstractfactory/ProductB2.java) | [`ProductA1`](../../python/src/patterns/abstractfactory/product_a1.py), [`ProductA2`](../../python/src/patterns/abstractfactory/product_a2.py), [`ProductB1`](../../python/src/patterns/abstractfactory/product_b1.py), [`ProductB2`](../../python/src/patterns/abstractfactory/product_b2.py) | [`ProductA1`](../../typescript/src/abstract-factory/product-a1.ts), [`ProductA2`](../../typescript/src/abstract-factory/product-a2.ts), [`ProductB1`](../../typescript/src/abstract-factory/product-b1.ts), [`ProductB2`](../../typescript/src/abstract-factory/product-b2.ts) | [`ProductA1`](../../javascript/src/abstract-factory/product-a1.js), [`ProductA2`](../../javascript/src/abstract-factory/product-a2.js), [`ProductB1`](../../javascript/src/abstract-factory/product-b1.js), [`ProductB2`](../../javascript/src/abstract-factory/product-b2.js) |
| Client | Uses only the abstract types. | [`AbstractFactoryExample`](../../java/src/main/java/com/penapereira/patterns/abstractfactory/AbstractFactoryExample.java) | [`AbstractFactoryExample`](../../python/src/patterns/abstractfactory/example.py) | [`abstractFactoryExample`](../../typescript/src/abstract-factory/example.ts) | [`abstractFactoryExample`](../../javascript/src/abstract-factory/example.js) |
## The example
