...
|---|---|---|---|---|---|
| Strategy | The interface common to all algorithms: `executeAlgorithm()`. | [`Strategy`](../../java/src/main/java/com/penapereira/patterns/strategy/Strategy.java) | [`Strategy`](../../python/src/patterns/strategy/__init__.py) (Protocol, `execute_algorithm`) | [`Strategy`](../../typescript/src/strategy/strategy.ts) | implicit: any object with `executeAlgorithm()` ([`strategy.js`](../../javascript/src/strategy/strategy.js)) |
