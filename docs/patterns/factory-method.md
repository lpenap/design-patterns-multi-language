...
|---|---|---|---|---|---|
| Product | The interface of the objects the factory method creates: `name()`. | [`Product`](../../java/src/main/java/com/penapereira/patterns/factorymethod/Product.java) | [`Product`](../../python/src/patterns/factorymethod/__init__.py) (Protocol) | [`Product`](../../typescript/src/factory-method/factory-method.ts) | implicit: any object with `name()` ([`factory-method.js`](../../javascript/src/factory-method/factory-method.js)) |
