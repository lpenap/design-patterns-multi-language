...
| ConcreteProduct | Implements the Product interface. | [`ConcreteProductA`](../../java/src/main/java/com/penapereira/patterns/factorymethod/ConcreteProductA.java), [`ConcreteProductB`](../../java/src/main/java/com/penapereira/patterns/factorymethod/ConcreteProductB.java) | [`ConcreteProductA`](../../python/src/patterns/factorymethod/concrete_product_a.py), [`ConcreteProductB`](../../python/src/patterns/factorymethod/concrete_product_b.py) | [`ConcreteProductA`](../../typescript/src/factory-method/concrete-product-a.ts), [`ConcreteProductB`](../../typescript/src/factory-method/concrete-product-b.ts) | [`ConcreteProductA`](../../javascript/src/factory-method/concrete-product-a.js), [`ConcreteProductB`](../../javascript/src/factory-method/concrete-product-b.js) |
| Creator | Declares the abstract `factoryMethod()` and calls it from `anOperation()`, its template operation. | [`Creator`](../../java/src/main/java/com/penapereira/patterns/factorymethod/Creator.java) | [`Creator`](../../python/src/patterns/factorymethod/creator.py) (ABC, `factory_method`, `an_operation`) | [`Creator`](../../typescript/src/factory-method/creator.ts) (abstract class) | [`Creator`](../../javascript/src/factory-method/creator.js) (base method throws) |
| ConcreteCreator | Overrides `factoryMethod()` to decide what is created. | [`ConcreteCreatorA`](../../java/src/main/java/com/penapereira/patterns/factorymethod/ConcreteCreatorA.java), [`ConcreteCreatorB`](../../java/src/main/java/com/penapereira/patterns/factorymethod/ConcreteCreatorB.java) | [`ConcreteCreatorA`](../../python/src/patterns/factorymethod/concrete_creator_a.py), [`ConcreteCreatorB`](../../python/src/patterns/factorymethod/concrete_creator_b.py) | [`ConcreteCreatorA`](../../typescript/src/factory-method/concrete-creator-a.ts), [`ConcreteCreatorB`](../../typescript/src/factory-method/concrete-creator-b.ts) | [`ConcreteCreatorA`](../../javascript/src/factory-method/concrete-creator-a.js), [`ConcreteCreatorB`](../../javascript/src/factory-method/concrete-creator-b.js) |
| Client | Uses creators through the `Creator` type only. | [`FactoryMethodExample`](../../java/src/main/java/com/penapereira/patterns/factorymethod/FactoryMethodExample.java) | [`FactoryMethodExample`](../../python/src/patterns/factorymethod/example.py) | [`factoryMethodExample`](../../typescript/src/factory-method/example.ts) | [`factoryMethodExample`](../../javascript/src/factory-method/example.js) |
## The example
