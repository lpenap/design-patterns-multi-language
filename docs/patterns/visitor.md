...
| ConcreteVisitor | Implements one operation across all element classes, accumulating a result. | [`ConcreteVisitor1`](../../java/src/main/java/com/penapereira/patterns/visitor/ConcreteVisitor1.java), [`ConcreteVisitor2`](../../java/src/main/java/com/penapereira/patterns/visitor/ConcreteVisitor2.java) | [`ConcreteVisitor1`](../../python/src/patterns/visitor/concrete_visitor1.py), [`ConcreteVisitor2`](../../python/src/patterns/visitor/concrete_visitor2.py) | [`ConcreteVisitor1`](../../typescript/src/visitor/concrete-visitor1.ts), [`ConcreteVisitor2`](../../typescript/src/visitor/concrete-visitor2.ts) | [`ConcreteVisitor1`](../../javascript/src/visitor/concrete-visitor1.js), [`ConcreteVisitor2`](../../javascript/src/visitor/concrete-visitor2.js) |
| Element | Declares `accept(visitor)`. | [`Element`](../../java/src/main/java/com/penapereira/patterns/visitor/Element.java) | [`Element`](../../python/src/patterns/visitor/element.py) (Protocol) | [`Element`](../../typescript/src/visitor/element.ts) | implicit: any object with `accept` |
| ConcreteElement | Implements `accept` by calling the visit method for its own class. | [`ConcreteElementA`](../../java/src/main/java/com/penapereira/patterns/visitor/ConcreteElementA.java), [`ConcreteElementB`](../../java/src/main/java/com/penapereira/patterns/visitor/ConcreteElementB.java) | [`ConcreteElementA`](../../python/src/patterns/visitor/concrete_element_a.py), [`ConcreteElementB`](../../python/src/patterns/visitor/concrete_element_b.py) | [`ConcreteElementA`](../../typescript/src/visitor/concrete-element-a.ts), [`ConcreteElementB`](../../typescript/src/visitor/concrete-element-b.ts) | [`ConcreteElementA`](../../javascript/src/visitor/concrete-element-a.js), [`ConcreteElementB`](../../javascript/src/visitor/concrete-element-b.js) |
| ObjectStructure | Enumerates its elements and lets a visitor visit each. | [`ObjectStructure`](../../java/src/main/java/com/penapereira/patterns/visitor/ObjectStructure.java) | [`ObjectStructure`](../../python/src/patterns/visitor/object_structure.py) | [`ObjectStructure`](../../typescript/src/visitor/object-structure.ts) | [`ObjectStructure`](../../javascript/src/visitor/object-structure.js) |
| Client | Creates visitors and applies them to the structure. | [`VisitorExample`](../../java/src/main/java/com/penapereira/patterns/visitor/VisitorExample.java) | [`VisitorExample`](../../python/src/patterns/visitor/example.py) | [`visitorExample`](../../typescript/src/visitor/example.ts) | [`visitorExample`](../../javascript/src/visitor/example.js) |
## The example
