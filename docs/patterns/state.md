...
|---|---|---|---|---|---|
| Context | Defines the interface clients use and holds the current state; delegates state-specific requests to it. | [`Context`](../../java/src/main/java/com/penapereira/patterns/state/Context.java) | [`Context`](../../python/src/patterns/state/context.py) (`request`, `set_state`, `get_state_name`) | [`Context`](../../typescript/src/state/state.ts) | [`Context`](../../javascript/src/state/state.js) |
