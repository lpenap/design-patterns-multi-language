...
| State | The interface for behaviour associated with a state of the Context. | [`State`](../../java/src/main/java/com/penapereira/patterns/state/State.java) | [`State`](../../python/src/patterns/state/state.py) (Protocol) | [`State`](../../typescript/src/state/state.ts) | implicit: any object with `handle` and `name` |
| ConcreteState | Implements the behaviour of one state and decides the transition. | [`ConcreteStateA`](../../java/src/main/java/com/penapereira/patterns/state/ConcreteStateA.java), [`ConcreteStateB`](../../java/src/main/java/com/penapereira/patterns/state/ConcreteStateB.java) | [`ConcreteStateA`](../../python/src/patterns/state/concrete_state_a.py), [`ConcreteStateB`](../../python/src/patterns/state/concrete_state_b.py) | [`ConcreteStateA`](../../typescript/src/state/concrete-state-a.ts), [`ConcreteStateB`](../../typescript/src/state/concrete-state-b.ts) | [`ConcreteStateA`](../../javascript/src/state/concrete-state-a.js), [`ConcreteStateB`](../../javascript/src/state/concrete-state-b.js) |
| Client | Issues requests to the context; never touches states. | [`StateExample`](../../java/src/main/java/com/penapereira/patterns/state/StateExample.java) | [`StateExample`](../../python/src/patterns/state/example.py) | [`stateExample`](../../typescript/src/state/example.ts) | [`stateExample`](../../javascript/src/state/example.js) |
## The example
