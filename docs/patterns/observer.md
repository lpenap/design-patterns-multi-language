...
|---|---|---|---|---|---|
| Subject | Knows its observers; offers `attach()`, `detach()` and `notifyObservers()`. | [`Subject`](../../java/src/main/java/com/penapereira/patterns/observer/Subject.java) | [`Subject`](../../python/src/patterns/observer/__init__.py) (`attach`, `detach`, `notify_observers`) | [`Subject`](../../typescript/src/observer/observer.ts) | [`Subject`](../../javascript/src/observer/observer.js) |
