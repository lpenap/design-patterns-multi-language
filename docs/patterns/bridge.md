...
|---|---|---|---|---|---|
| Abstraction | Defines the abstraction's interface and holds the implementor; `operation()` forwards the primitive to it. | [`Abstraction`](../../java/src/main/java/com/penapereira/patterns/bridge/Abstraction.java) | [`Abstraction`](../../python/src/patterns/bridge/abstraction.py) | [`Abstraction`](../../typescript/src/bridge/bridge.ts) | [`Abstraction`](../../javascript/src/bridge/bridge.js) |
