...
|---|---|---|---|---|---|
| Abstraction | Defines the abstraction's interface and holds the implementor; `operation()` forwards the primitive to it. | [`Abstraction`](../../java/src/main/java/com/penapereira/patterns/bridge/Abstraction.java) | [`Abstraction`](../../python/src/patterns/bridge/abstraction.py) | [`Abstraction`](../../typescript/src/bridge/abstraction.ts) | [`Abstraction`](../../javascript/src/bridge/abstraction.js) |
| RefinedAbstraction | Extends the abstraction's interface or behaviour. | [`RefinedAbstraction`](../../java/src/main/java/com/penapereira/patterns/bridge/RefinedAbstraction.java) | [`RefinedAbstraction`](../../python/src/patterns/bridge/refined_abstraction.py) | [`RefinedAbstraction`](../../typescript/src/bridge/refined-abstraction.ts) | [`RefinedAbstraction`](../../javascript/src/bridge/refined-abstraction.js) |
| Implementor | The interface for implementation classes; primitive operations only. | [`Implementor`](../../java/src/main/java/com/penapereira/patterns/bridge/Implementor.java) | [`Implementor`](../../python/src/patterns/bridge/implementor.py) (Protocol, `operation_impl`) | [`Implementor`](../../typescript/src/bridge/implementor.ts) | implicit: any object with `operationImpl()` |
| ConcreteImplementor | Implements the Implementor interface. | [`ConcreteImplementorA`](../../java/src/main/java/com/penapereira/patterns/bridge/ConcreteImplementorA.java), [`ConcreteImplementorB`](../../java/src/main/java/com/penapereira/patterns/bridge/ConcreteImplementorB.java) | [`ConcreteImplementorA`](../../python/src/patterns/bridge/concrete_implementor_a.py), [`ConcreteImplementorB`](../../python/src/patterns/bridge/concrete_implementor_b.py) | [`ConcreteImplementorA`](../../typescript/src/bridge/concrete-implementor-a.ts), [`ConcreteImplementorB`](../../typescript/src/bridge/concrete-implementor-b.ts) | [`ConcreteImplementorA`](../../javascript/src/bridge/concrete-implementor-a.js), [`ConcreteImplementorB`](../../javascript/src/bridge/concrete-implementor-b.js) |
| Client | Combines an abstraction with an implementor. | [`BridgeExample`](../../java/src/main/java/com/penapereira/patterns/bridge/BridgeExample.java) | [`BridgeExample`](../../python/src/patterns/bridge/example.py) | [`bridgeExample`](../../typescript/src/bridge/example.ts) | [`bridgeExample`](../../javascript/src/bridge/example.js) |
## The example
