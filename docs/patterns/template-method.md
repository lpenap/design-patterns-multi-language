...
|---|---|---|---|---|---|
| AbstractClass | `templateMethod()` fixes the algorithm as `primitiveOperation1()` then `primitiveOperation2()` then `hook()`. The primitive operations are abstract; the hook has a default (empty) implementation. | [`AbstractClass`](../../java/src/main/java/com/penapereira/patterns/templatemethod/AbstractClass.java) | [`AbstractClass`](../../python/src/patterns/templatemethod/__init__.py) (`template_method`, `primitive_operation_1`, `primitive_operation_2`, `hook`) | [`AbstractClass`](../../typescript/src/template-method/template-method.ts) | [`AbstractClass`](../../javascript/src/template-method/template-method.js) |
