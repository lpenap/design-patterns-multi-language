...
|---|---|---|---|---|---|
| Component | The interface shared by objects that can have responsibilities added: `operation()`. | [`Component`](../../java/src/main/java/com/penapereira/patterns/decorator/Component.java) | [`Component`](../../python/src/patterns/decorator/__init__.py) (Protocol) | [`Component`](../../typescript/src/decorator/decorator.ts) | implicit: any object with `operation()` ([`decorator.js`](../../javascript/src/decorator/decorator.js)) |
