...
| Client | Obtains the instance through `instance()` only. | [`SingletonExample`](../../java/src/main/java/com/penapereira/patterns/singleton/SingletonExample.java) | [`SingletonExample`](../../python/src/patterns/singleton/example.py) | [`singletonExample`](../../typescript/src/singleton/example.ts) | [`singletonExample`](../../javascript/src/singleton/example.js) |
## The example
