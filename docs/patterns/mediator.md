...
| Client | Wires colleagues to the mediator and triggers messages. | [`MediatorExample`](../../java/src/main/java/com/penapereira/patterns/mediator/MediatorExample.java) | `MediatorExample` | [`mediatorExample`](../../typescript/src/mediator/example.ts) | [`mediatorExample`](../../javascript/src/mediator/example.js) |
