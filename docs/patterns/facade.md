...
| Subsystem classes | Implement the subsystem's functionality; know nothing of the façade. | [`SubsystemA`](../../java/src/main/java/com/penapereira/patterns/facade/SubsystemA.java), [`SubsystemB`](../../java/src/main/java/com/penapereira/patterns/facade/SubsystemB.java), [`SubsystemC`](../../java/src/main/java/com/penapereira/patterns/facade/SubsystemC.java) | [`SubsystemA`](../../python/src/patterns/facade/subsystem_a.py), [`SubsystemB`](../../python/src/patterns/facade/subsystem_b.py), [`SubsystemC`](../../python/src/patterns/facade/subsystem_c.py) | [`SubsystemA`](../../typescript/src/facade/subsystem-a.ts), [`SubsystemB`](../../typescript/src/facade/subsystem-b.ts), [`SubsystemC`](../../typescript/src/facade/subsystem-c.ts) | [`SubsystemA`](../../javascript/src/facade/subsystem-a.js), [`SubsystemB`](../../javascript/src/facade/subsystem-b.js), [`SubsystemC`](../../javascript/src/facade/subsystem-c.js) |
| Client | Talks to the façade only. | [`FacadeExample`](../../java/src/main/java/com/penapereira/patterns/facade/FacadeExample.java) | [`FacadeExample`](../../python/src/patterns/facade/example.py) | [`facadeExample`](../../typescript/src/facade/example.ts) | [`facadeExample`](../../javascript/src/facade/example.js) |
## The example
