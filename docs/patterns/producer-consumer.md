...
|---|---|---|---|---|---|
| BoundedBuffer | Mutual exclusion plus the two wait conditions; `put()` waits while full, `take()` waits while empty; FIFO. | [`BoundedBuffer`](../../java/src/main/java/com/penapereira/patterns/producerconsumer/BoundedBuffer.java) (`ReentrantLock`, two `Condition`s) | [`BoundedBuffer`](../../python/src/patterns/producerconsumer/__init__.py) (`threading.Condition`) | [`BoundedBuffer`](../../typescript/src/producer-consumer/producer-consumer.ts) (generator `put`/`take`) | [`BoundedBuffer`](../../javascript/src/producer-consumer/producer-consumer.js) |
